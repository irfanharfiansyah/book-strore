...
<body>
    ...
    <div class="text-center ">
        <h1 class="py-4 bg-dark text-light "><i class="fas fa-swatchbook"></i> Book Store</h1>
                        ...
                        if ($result) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) { ?>
                                ...
                                <tr>
                                    ...
                                    <td data-id="<?php echo $row['id']; ?>"><?php echo 'Rp.' . $row['book_price']; ?></td>
                                    <td data-id="<?php echo $row['id']; ?>"><?php echo $row['image_book']; ?></td>
